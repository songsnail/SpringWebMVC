...
<div class="container">
  ...
  <div class="form-group row">
      <label class="col-sm-2 control-label" for="customerId" >고객 ID</label>
      <div class="col-sm-3">
  ...
  <div class="form-group row">
   ...
   <div class="form-group row">
      <label class="col-sm-2 control-label" for="country">국가명</label>
      <div class="col-sm-3">
         <form:input path="address.country"  class="form-control"/>
      </div>
   </div>
   <div class="form-group row">
      <label class="col-sm-2 control-label" for="zipCode">우편번호</label>
      <div class="col-sm-3">
         <form:input path="address.zipCode" class="form-control" />
      </div>
   </div>
   <div class="form-group row">
      <label class="col-sm-2 control-label" for="addressName">주소</label>
      <div class="col-sm-5">
         <form:input path="address.addressName" class="form-control" />
      </div>
   </div>
   <div class="form-group row">
      <label class="col-sm-2 control-label" for="detailName">세부주소</label>
      <div class="col-sm-3">
       <form:input path="address.detailName" type="text" class="form-control" />
      </div>
   </div>	
